...
# body {
#   background-image: url('https://github.com/twitch-bridge/twitch-bridge.github.io/blob/master/bridge-cards.jpg?raw=true');
...
results <- importdata("~/Downloads/BFC2 Scoresheet - Sheet1 (8).csv")
